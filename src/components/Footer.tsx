    ...
    <footer className="bg-primary text-white pt-16 pb-4">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div>
            <h3 className="font-semibold text-sm mb-4 uppercase">QUICK LINKS</h3>
          ...
          <div>
            <h3 className="font-semibold text-sm mb-4 uppercase">OUR PROGRAMS</h3>
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-300">
              <div>
                <h4 className="font-medium mb-2">CITIZENSHIP</h4>
          ...
          <div>
            <h3 className="font-semibold text-sm mb-4 uppercase">INVESTMENT TYPE</h3>
            <ul className="space-y-2 text-xs text-gray-300">
          ...
          <div>
            ...
            <form>
              <div className="flex items-center">
                <select className="text-xs bg-gray-700 text-white border-0 rounded-l-md py-2 px-3">
                  <option>English</option>
                  <option>Arabic</option>
                  <option>Russian</option>
                </select>
                <button type="button" className="bg-secondary text-white text-xs py-2 px-3 rounded-r-md">
                  GO
                </button>
              </div>
            </form>
        ...
        <div className="text-xs text-gray-400 text-center">
          © {new Date().getFullYear()} CITIZENSHIP INVEST. ALL RIGHTS RESERVED.
        </div>
      </div>
    </footer>
  );
